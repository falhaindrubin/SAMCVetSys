...
Public Class ClsDBAppointment
    ...
    Public Function GetAppointmentDetail(APP As ClsAppointment) As DataTable
        ...
        Try
            Sb = New StringBuilder
            With Sb
                .Append("SELECT a.AppointmentID, EmpID, EmpName, CustomerID, CustomerName, AppointmentTime, ")
    ...
    Public Function GetAppointmentSummary(ByVal APP As ClsAppointment, ByRef DBConn As OdbcConnection) As DataTable
        ...
        Try
            Sb = New StringBuilder
            With Sb
                .Append("SELECT AppointmentID, EmpID, EmpName, a.CustomerID, a.CustomerName, a.PetID, a.PetName, SexName, PetDOB, b.AnimalTypeName, b.BreedName, b.StatusName, AppointmentTime, AppointmentDesc AS 'PetIssue' ")
                .Append("FROM samc_appointment a ")
