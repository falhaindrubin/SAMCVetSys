...
Public Class RptCustomerInvoice
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SAMCVetSys.RptCustomerInvoice.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptCustomerInvoice
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptCustomerInvoice = New RptCustomerInvoice()
        rpt.Site = Me.Site
        Return rpt
    End Function
